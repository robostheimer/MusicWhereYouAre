							...
							if(titleArr[i] == null || locationArr[i] == null || spotArr[i] == null) {
									...
									for (var n = 0; n < localStorage.length; n++) {
										...
										if (spot_link == spotArr[i]) {
											info.push(city + '$$' + lat + '&&' + long + '%%<p class="info" id="infobox_pinfo' + i + '">' + titleArr[i] + '<br/>by ' + cleanStr(artistArr[i], /\+/g,'&#43;') + '</p><div class="border"><a href="https://embed.spotify.com/?uri=spotify:track:6jBbbCvTCQKKaLgzucpnTb' + spotArr[i] + '" target="_blank"><div class="spot_link" " aria-hidden="true" data-icon="c" id="infobox_spot_link' + i + '"></div></a><a><div onclick="addFavorite($(this).attr(\'id\'),$(this).attr(\'title\'))" class="spot_link infob favorite favorite_on" id="infobox_favorite' + i + '" title="' +spotArr[i] + '" aria-hidden="true" data-icon="t"></div></a><a><div onclick=addInfo($(this).attr(\'id\')); style="font-size:20px" class="spot_link information" id="infobox_info' + i + '" " aria-hidden="true" data-icon="*"></div></a><div class="clear_border""></div></div>>');
										}
									}
									///Note uses "onclick" attribute instead of clickhandler because of the way the InfoWindow object works in Google Maps
										if (!info.toString().match(spotArr[i])) {
										info.push(city + '$$' + lat + '&&' + long + '%%<p class="info" id="infobox_pinfo' + i + '">' + titleArr[i] + '<br/>by ' + cleanStr(artistArr[i], /\+/g,'&#43;') + '</p><a href="https://embed.spotify.com/?uri=spotify:track:6jBbbCvTCQKKaLgzucpnTb' +spotArr[i] + '" target="_blank"><div class="spot_link" " aria-hidden="true" data-icon="c" id="infobox_spot_link' + i + '"></div></a><a><div onclick="addFavorite($(this).attr(\'id\'),$(this).attr(\'title\'))" class="spot_link infob favorite" id="infobox_favorite' + i + '" title="' + spotArr[i] + '"  aria-hidden="true" data-icon="u"></div></a><a ><div onclick=addInfo($(this).attr(\'id\')); style="font-size:20px" class="spot_link information" id="infobox_info' + i + '" " aria-hidden="true" data-icon="*"></div></a><div class="clear_border";"></div>');
									}
